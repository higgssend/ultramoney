      ...
      <section id="inicio" className="min-h-screen flex flex-col justify-center pt-28 lg:pt-36 pb-20 bg-gradient-to-b from-indigo-50/70 via-slate-50 to-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            {/* Right Column: React Bits TiltedCard 3D Interactive Mockup */}
            <div className="lg:col-span-7 hero-mockup relative">
              <TiltedCard maxAngle={8} scale={1.02} glareEffect={true} className="w-full">
                <div className="relative rounded-3xl bg-white p-2 sm:p-3 shadow-2xl shadow-indigo-500/20 border border-slate-200/90 max-w-2xl mx-auto lg:max-w-none">
                  
                  {/* Mockup Frame Bar */}
                  <div className="bg-slate-50 border border-slate-100 rounded-2xl overflow-hidden text-left">
                    <div className="flex items-center justify-between px-4 py-2.5 bg-slate-100/80 border-b border-slate-200/60">
                      ...
                      <div className="bg-white px-6 py-0.5 rounded-md border border-slate-200 text-[10px] text-slate-400 flex items-center gap-1">
                    ...
                    {/* Inner UI Preview */}
                    <div className="flex min-h-[370px] bg-slate-50 text-[11px]">
                      <div className="w-40 bg-white border-r border-slate-200/80 p-3 hidden sm:flex flex-col justify-between">
                        <div className="space-y-3">
                      ...
                      <div className="flex-1 p-3.5 space-y-3 overflow-hidden bg-slate-50/80">
                        ...
                        <div className="bg-white p-3.5 rounded-xl border border-slate-200/60">
                          <div className="flex justify-between items-center mb-1">
                            ...
                            <span className="text-[8px] bg-emerald-50 text-emerald-600 font-bold px-2 py-0.5 rounded-full">+18% este mes</span>
                          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-16 pt-6">
            ...
            >
              ...
              <p className="text-xs font-bold text-slate-500">Préstamos Administrados</p>
            </SpotlightCard>
            ...
            <SpotlightCard
              ...
              className="bg-white text-center space-y-2 p-5"
            >
              <DollarSign className="w-6 h-6 text-amber-600 mx-auto" />
              <p className="text-2xl sm:text-3xl font-black text-slate-900">
                <Counter end={450} prefix="+RD$ " suffix="M" />
              </p>
              <p className="text-xs font-bold text-slate-500">Volumen Financiero</p>
            </SpotlightCard>
            ...
            >
              ...
              <p className="text-2xl sm:text-3xl font-black text-slate-900">
                <DecryptedText text="99.98%" speed={40} className="font-black text-slate-900" />
              </p>
              <p className="text-xs font-bold text-slate-500">Disponibilidad Cloud & PWA</p>
            </SpotlightCard>
          </div>
      ...
      <section className="min-h-screen flex flex-col justify-center py-28 bg-slate-950 text-white relative overflow-hidden border-t border-slate-800">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center space-y-8">
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto font-normal leading-relaxed">
            Elimina los errores manuales de cálculo, automatiza la cobranza diaria en calle con GPS y emite comprobantes oficiales en segundos.
          </p>
