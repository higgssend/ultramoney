...
export const LoanDetail: React.FC = () => {
  ...
  const handleOpenThermalReceipt = (t: Transaction) => {
    ...
    const thermalData: ThermalReceiptData = {
      ...
      installmentInfo: calculated.installmentText || `Cuota ${loan.frequency || 'Mensual'}`,
          ...
          <div className="bg-amber-50/90 dark:bg-amber-950/40 p-6 rounded-3xl border border-amber-200 dark:border-amber-900/60 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-3.5 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-xl text-xs font-bold transition-all shadow-xs flex items-center gap-1.5"
              >
                <Shield className="w-3.5 h-3.5" /> Ver en Bóveda & Custodia
              </button>
            </div>
          </div>
