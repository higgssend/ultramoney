...
const WhatsAppIcon = () => (
  <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="w-4 h-4">
...
export const Payments: React.FC = () => {
  ...
  const paymentTransactions = useMemo(() => {
    return transactions
      .filter(t => t && t.type === 'Ingreso' && (t.category === 'Pago Préstamo' || t.category === 'Cobro' || t.category === 'Cobranza' || t.referenceId))
