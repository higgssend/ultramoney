...
const ThermalReceiptPage = React.lazy(() => import('./pages/ThermalReceiptPage'));
const PublicDocumentView = React.lazy(() => import('./pages/PublicDocumentView'));
const ClientAccountStatementPage = React.lazy(() => import('./pages/ClientAccountStatementPage'));
            ...
            <Suspense fallback={<PageLoader />}>
              <PageTransition>
                <Routes location={location}>
                  ...
                  <Route path="/cliente/nuevo" element={<ProtectedRoute><NewClient /></ProtectedRoute>} />
                  <Route path="/clientes/crear" element={<ProtectedRoute><NewClient /></ProtectedRoute>} />
                  ...
                  <Route path="/custodia" element={<ProtectedRoute><VaultCustodyPage /></ProtectedRoute>} />
